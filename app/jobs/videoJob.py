...
from app.services.NewsMediaProcessor import NewsMediaProcessor, create_video_with_music, create_social_media_description
...
def run_video_cron_job():
    ...
    for i in range(len(news_list['news'])):
        news = news_list['news'][i]
    ...
    final_clip = create_video_with_music(image_paths, 'media/output_video.mp4', f"media/music/music{random_number}.mp3")
    create_social_media_description(news_list)
